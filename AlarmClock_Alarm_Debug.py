...
import AlarmClock_Screen_Debug
#import RPi
import pickle
...
def Get_ActualTime_in_Seconds():
    ...
    """
    try:
        ActualTime, ActualTimeDisplay = AlarmClock_Screen_Debug.Get_ActualTime()  # get as dictionary object Hour,Mins,Secs
    ...
    try:
        while True:
            ...
            if Alarm1Active == True:
                ...
                sleep(1) #sleep for 1 hour in seconds to preserve battery, take out for initial debug
